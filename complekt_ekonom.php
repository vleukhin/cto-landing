	...
	<div class="wrap-section-string-form">
			...
			<div class="row">
				<div class="col-md-12 section-title section-title-2">
					<h2><span>Финальная распродажа</span></h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-3 col-xs-3 cat-img-5-box">
					<img src="img/ekonom.png" width="538" alt="" class="section-2-img img-left cat-img-5 cat-box-index">
				</div>
				<div class="col-md-8 col-sm-9 col-xs-9 section-block-text block-text-1 index-block-text">
					<h3>Готовый комплект шиномонтажа<br>
					<span>«Эконом»</span></h3>
					<p><b>Шиномонтажный станок</b> <span>NORDBERG 4638E</span><br>
					(полуавтомат, до 21", питание 220\380 В, усилие отжима<br> 
					2500 кг, мощность мотора 0,75-1,1 кВт)<br>
						<b>Балансировочный станок</b><span> NORDBERG ECO 4523C</span><br>
					(ручной ввод, до 24", питание 220 В, мощность мотора 370 Вт,<br> 
					педаль остановки колеса)<br>
					<b>Компрессор поршневой</b><span> NORDBERG ECO NCE100/400</span><br>
					(ременный привод, ресивер 100 л,<br>
					производительность 400 л/мин)<br>
					<b>Домкрат подкатной</b><span> NORDBERG N32025</span><br>
					(грузоподъемность 2,5 т, усиленная конструкция, кардан,<br> 
					клапан защиты от перегрузок, высота 130-425 мм)<br>
					Пневмогайковерт ударный<span> NORDBERG ECO NP14068</span><br>
					(размер квадрата 1/2", максимальное усилие 680 нм,<br> 
					обороты 7000 об/мин, механизм TWIN-HAMMER)</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="modal-box">
					...
					<input type="hidden" name="subject" value="Оставьте имя и телефон и с вами свяжется старший менеджер">
						...
						<div class="wrap-input-telephone-price">
							<input class="input-text input-modal"  type="text" name="phone" placeholder="Ваш телефон" >
						</div>

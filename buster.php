	...
	<div class="wrap-section-string-form">
			...
			<div class="row">
				<div class="col-md-4 col-sm-3 col-xs-3 cat-img-5-box">
					<img src="img/buster.png" width="538" alt="" class="section-2-img img-left cat-img-5 cat-box-index cat-box-index-1">
				</div>
				<div class="col-md-8 col-sm-9 col-xs-9 section-block-text block-text-1">
					<h3>Бустер автомат с пневмоклапаном<br>
					<span>Nordberg CH-5A</span></h3>
					<p>Объем резервуара – 10 л<br>
					Габариты упаковки, мм – 820х200х260<br>
					Вес упаковки, кг – 13,5<br>
					Максимальное давление, бар – 12</p>
				</div>
			</div>
			<div class="row">

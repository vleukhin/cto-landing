	...
	<div class="wrap-section-string-form">
			...
			<div class="row">
				<div class="col-md-4 col-sm-3 col-xs-3 cat-img-5-box">
					<img src="img/rashodnye_materialy.png" width="538" alt="" class="section-2-img img-left cat-img-5 cat-box-index">
				</div>
				<div class="col-md-8 col-sm-9 col-xs-9 section-block-text block-text-1">
					<h3>Расходные материалы <span>по ценам 2016</span> года<br>со скидкой от <span>15%</span> до <span>20%</span>
					<br>
					<br>
					<span>Более 120 наименований</span><br></h3>
					<p>Грузики ст, лит, груз, самоклеящиеся. Жгуты. Грибки.<br> Камерные лотки. Универсальные заплаты. Пластыри<br> кордовые. Вентили. Химия. Инструменты.</p>
				</div>
			</div>
			<div class="row">

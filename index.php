...
<body>
	...
	<div class="wrap-section-string-form">
			...
			<div class="row">
				...
				</div><div class="compliance" style="text-align:center; margin-top:-10%; margin-bottom:5%; font-size:9px; font-weight:300;"> <a href="#openModal3" target="_self" style="color:#D3D3D3; text-decoration: underline;">Нажимая кнопку, вы даете согласие на обработку персональных данных</a></div>
			</div>
	...
	<div class="container section-string-form">
			...
			<div class="row">
				<div class="col-md-12 catalog-wrap-2">
					...
					</div><div class="compliance" style="text-align:right; margin-top:-8%; margin-bottom:5%; font-size:9px; font-weight:300;"><a href="#openModal3" target="_self" style="color:#D3D3D3; text-decoration: underline;">Нажимая кнопку, вы даете согласие на обработку персональных данных</a></div>
				</div>
			</div>
		</div>
	<div class="wrap-section-string-form">
...
<?php echo $brands_arr[$brand_id]["brandName"];?>&nbsp; <span>с ценами производителя</span></h4>
					...
					<input type="hidden" name="typsh" value="минитрактор">
					</form><div class="compliance" style="font-size:9px; font-weight:300;"><a href="#openModal3" target="_self" style="color:#D3D3D3; text-decoration: underline;">Нажимая кнопку, вы даете согласие на обработку персональных данных</a></div>
					</div>
				</div>  
			</div>
		</div>
					...
					<div class="form-catalog-wrap" style="margin-bottom:10%">
						<div class="form-catalog-left" style="background:#fe475a">
							 ...
							 <input type="hidden" name="subject" value="минитрактор">
								...
								<input class="input-text input-email input-string-form input-string-form-3" type="email" name="email" placeholder="Почта">
                                 <div class="alert_on" id="phone_bottom_3"></div>
                                 <span style="font-size:19px; color:yellow; text-transform:uppercase; font-weight:700; margin-left:5%;">Ваша выгода</span><strong><span style="font-size:35px; color:yellow;">15 500 р.</span></strong><br><div class="alert_on" id="phone_bottom_3"></div> 
					...
					<div class="form-catalog-wrap" style="margin-bottom:10%">
						<div class="form-catalog-left" style="background:#fe475a">
							 ...
							 <input type="hidden" name="subject" value="минитрактор">
								...
								<input class="input-text input-email input-string-form input-string-form-3" type="email" name="email" placeholder="Почта">
                                 <div class="alert_on" id="phone_bottom_3"></div>
                                 <span style="font-size:19px; color:yellow; text-transform:uppercase; font-weight:700; margin-left:5%;">Ваша выгода</span><strong><span style="font-size:35px; color:yellow;"> 6 500 р.</span></strong><br><div class="alert_on" id="phone_bottom_3"></div> 
					...
					<div class="form-catalog-wrap" style="margin-bottom:10%">
						<div class="form-catalog-left" style="background:#fe475a">
							 ...
							 <input type="hidden" name="subject" value="Минитрактора. Оставьте ваши имя и телефон, чтобы получить каталог">
								...
								<input class="input-text input-phone input-string-form phone-mask" id="inputf3"  maxlength="18"  type="text" name="phone" placeholder="Телефон*" required onClick="moveCaretToStart(this)">
								<input class="input-text input-email input-string-form input-string-form-3" type="email" name="email" placeholder="Почта">
                                 <span style="font-size:19px; color:yellow; text-transform:uppercase; font-weight:700; margin-left:5%;">Ваша выгода</span><span style="font-size:35px; color:yellow;"><strong> 9 400 р.</strong></span><br><div class="alert_on" id="phone_bottom_3"></div> 
					...
					<div class="form-catalog-wrap" style="margin-bottom:10%">
						<div class="form-catalog-left" style="background:#fe475a">
							 ...
							 <input type="hidden" name="subject" value="Минитрактора. Оставьте ваши имя и телефон, чтобы получить каталог">
								...
								<input class="input-text input-phone input-string-form phone-mask" id="inputf3"  maxlength="18"  type="text" name="phone" placeholder="Телефон*" required onClick="moveCaretToStart(this)">
								<input class="input-text input-email input-string-form input-string-form-3" type="email" name="email" placeholder="Почта">
                                 <span style="font-size:19px; color:yellow; text-transform:uppercase; font-weight:700; margin-left:5%;">Ваша выгода</span><span style="font-size:35px; color:yellow;"><strong> 13 800 р.</strong></span><br><div class="alert_on" id="phone_bottom_3"></div> 
					...
					<div class="form-catalog-wrap" style="margin-bottom:10%">
						<div class="form-catalog-left" style="background:#fe475a">
							 ...
							 <input type="hidden" name="subject" value="Минитрактора. Оставьте ваши имя и телефон, чтобы получить каталог">
								...
								<input class="input-text input-phone input-string-form phone-mask" id="inputf3"  maxlength="18"  type="text" name="phone" placeholder="Телефон*" required onClick="moveCaretToStart(this)">
								<input class="input-text input-email input-string-form input-string-form-3" type="email" name="email" placeholder="Почта">
                                 <span style="font-size:19px; color:yellow; text-transform:uppercase; font-weight:700; margin-left:5%;">Ваша выгода</span><span style="font-size:35px; color:yellow;"><strong> 25 000 р.</strong></span><br><div class="alert_on" id="phone_bottom_3"></div> 
...
<?php echo $brands_arr[$brand_id]["brandName"];?>&nbsp;<span>с ценами производителя</span></h4>
 <input type="hidden" name="subject" value="Получи общий прайс-лист на оборудование<?php echo $brands_arr[$brand_id]["brandName"];?>&nbsp; на минитракторы">
						...
						</div><div class="compliance" style="font-size:9px; font-weight:300;"><a href="#openModal3" target="_self" style="color:#D3D3D3; text-decoration: underline;">Нажимая кнопку, вы даете согласие на обработку персональных данных</a></div>
						</form>
						<input type="hidden" name="typsh" value="минитрактор">
					</div>
				</div>

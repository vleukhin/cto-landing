	...
	<div class="wrap-section-string-form">
			...
			<div class="row">
				<div class="col-md-4 col-sm-3 col-xs-3 cat-img-5-box">
					<img src="img/PNEVMOGAJKOVERT.png" width="538" alt="" class="section-2-img img-left cat-img-5 cat-box-index">
				</div>
				<div class="col-md-8 col-sm-9 col-xs-9 section-block-text block-text-1">
					<h3>Пневмогайковерт ударный<br> 1/2" в кейсе, 850 нм<br>
					<span>NORDBERG ECO NP14085K</span></h3>
					<p>Размер квадрата – 1/2''<br>
					Максимальное усилие  – 850 Нм<br>
					Число оборотов – 7000 об/мин<br>
					Среднее потребление воздуха – 119 л/мин<br>
					Вес – 2,58 кг<br>
					&#216; входной воздушной резьбы – 1/4"<br>
					давление – 6,0 - 6,5 бар</p>
				</div>
			</div>
			<div class="row">
					...
					<div class="form-catalog-wrap">
						...
						<div class="form-catalog">
							 <form method="post" action="sender.php" class="sform">
								<p>оставьте ваши имя и телефон, чтобы купить оборудование</p>
								<input type="hidden" name="subject" value="Оставьте ваши имя и телефон, чтобы купить оборудование">
								...
								<div class="wrap-form-btn btn-position-right">
									<input class="form-button form-2-btn"  type="submit" name="catalog" value="Купить">
								</div>
							</form>
						</div>
					</div>
...
Мы свяжемся с Вами в ближайшее время.
 ...
 <script src="https://cdn.jsdelivr.net/g/bootstrap@3.3.6,jquery.maskedinput@1.4.1(jquery.maskedinput.js)"></script>	<script src="js/jquery.simslider.js"></script>
	<script>
		jQuery( function($){

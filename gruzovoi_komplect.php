	...
	<div class="container section-1">
		<div class="row">
			<div class="col-md-12 section-title section-title-1">
				<h2 style="font-size: 38px;"><span>закажи</span>&nbsp;готовый&nbsp;<span>комплект</span>&nbsp;грузового шиномонтажного оборудования в компании ЦТО и&nbsp;<span>зарабатывай от 2,5 миллионов в год</span></h2>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-sm-6 col-xs-6 section-1-equipment">
				<div class="equipment-img">
					<img src="img/set-cargo.jpg" width="350" alt="" style="max-width: 350px;" class="equipment-img-1">
				</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12 wrap-section-1-list">
				<div class="section-1-list" style="font-size:26px;">
					<ul>
						<li class="list-1-item item-1-1"><img src="img/icon-5.jpg" style="margin: -1% 4% 0 0;" alt=""><span>Готовый</span> бизнес план</li>
						<li class="list-1-item item-1-2"><img src="img/icon-6.jpg" style="margin: -1% 4% 0 0;" alt=""><span>Рекламная</span> поддержка</li>
						<li class="list-1-item item-1-3"><img src="img/icon-7.jpg" style="margin-left:0 !Important;margin-top: -1%;" alt=""><span>Уникальная программа</span> лояльности для клиентов</li>
						<li class="list-1-item item-1-4"><img src="img/icon-4.jpg" style="margin: -1% 4% 0 0;" alt="">Консультация специалиста</li>
					</ul>
				</div>
				<div class="price-final" style="margin-top:60px;text-align: center;font-size:32px; font-family: 'ProximaNovaBold', sans-serif;">
					<p>цена <span style="color: #fe475a;">549 900 руб*</span></p>
				</div>
			</div>
			<div class="col-md-4 col-sm-12 col-xs-12 section-1-form">
				<div class="section-1-form-wrap">
					<h4>Оставь заявку!<br>на акционное предложение</h4>
					<form method="post" action="sender.php" name="form" id="form_1" class="sform" onsubmit="yaCounter41896804.reachGoal('cel3'); return true;">
						<input type="hidden" name="subject" value="Оставь заявку!на акционное предложение. Грузовой комплект">
						...
						<div class="wrap-form-btn">
							<input class="form-button form-1-btn" type="submit" name="full_catalog" value="Отправить Заявку" onClick="validation('phone_bottom','inputf')" style="width: 100%;max-width: 310px;">
						</div>
					</form>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="wrap-table-cargo">
															<table style="background:#efefef;font-size: 13px;line-height: 1em;width:100%;">
																<tbody>
																	<tr>
																		<td style="width:50%;padding:10px 0 10px 15px;">Шиномонтажный станок Trommelberg 1580</td>
																		<td style="width:50%;padding:10px 0 10px 15px;">Домкрат Trommelberg SD101902</td>
																	</tr>
																	<tr>
																		<td style="width:50%;padding:10px 0 10px 15px;">Балансировочный станок Trommelberg CB1448</td>
																		<td style="width:50%;padding:10px 0 10px 15px;">Набор ударных торцевых головок 1" KING TONY 8410MP</td>
																	</tr>
																	<tr>
																		<td style="width:50%;padding:10px 0 10px 15px;">Компрессор поршневой 16 бар FIAC СБ4/Ф-500</td>
																		<td style="width:50%;padding:10px 0 10px 15px;"></td>
																	</tr>
																</tbody>
															</table>
															</div>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="wrap-q">
					<img class="q-img" src="img/q.jpg" alt="">
					<p class="top-q">НАША ЦЕЛЬ - успешный бизнесс наших клиентов!</p>
					<p class="bottom-q"><span style="color:#ff4f6b;text-transform:uppercase;font-weight:bold;font-size: 23px;">*Акция!</span>  При заказе грузового шиномонтажного<br> оборудования в компании ЦТО- <br> Пневмогайковерт <span style="font-weight:bold;">в</span> <span style="font-weight:bold;text-transform:uppercase;">подарок</span></p>
					<img class="gift-img" src="img/pnevmo.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6 map-box-1-wp">
						<div class="map-box map-box-1">
							<p><span style="background:#f6f6f6;">1</span>Выберите свой город</p>
						</div> 
					</div>
				<div class="col-md-6 col-sm-6 col-xs-6">
					
					<div class="map-box map-box-2">
						<p><span style="background:#f6f6f6;">2</span>Позвоните реальному клиенту,<br/>купившему оборудование </p>
					</div> 
				
				</div>
			</div>
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-6 map-text">
				...
				<div class="col-md-3 col-sm-6 col-xs-6 map-text">
					<p><span>33217</span><br/>Единиц оборудования в ассортименте</p>
				</div>
			</div>
			<div class="row ">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-6 footer-info">
					...
					<p><span style="margin-top: -10px;display: block;">Акция продлится до 30 апреля 2017 года</span></p>
				</div>
				<div class="col-md-6 col-sm-6 col-xs-6">
	...
	<div>
		...
		<div class="modal-box">
			...
			<form method="post" action="sender.php" id="form_12" class="sform" onsubmit="yaCounter41896804.reachGoal('cel1'); return true;">
				...
				<input type="hidden" name="subject" value="Грузовой комплект. Оставьте имя и телефон и с вами свяжется старший менеджер">
	...
	<div>
		...
		<div class="modal-box">
			...
			<form method="post" action="sender.php" id="form_20" class="sform" onsubmit="yaCounter41896804.reachGoal('cel20'); return true;">
				<input type="hidden" id="ya-city" value="">
				<input type="hidden" name="subject" value="Footer Грузовой комплект. Оставьте имя и телефон и с вами свяжется старший менеджер">
				<div class="wrap-input-name-price">
					<input class="input-text input-modal" type="text" name="name" placeholder="Ваше имя">
				</div>
				<div class="wrap-input-telephone-price">
